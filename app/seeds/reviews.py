...
def seed_reviews():
    ...
    reviews = [
        ...
        Review(
            place_id='ChIJT2cmiPSAhYARwyhb3VgcriM', user_id = demo.id, review="The best most vibey bar. I used to do my homeowork in the upstairs and drink dark and stormies. It's a truly beloved spot", rating=5
        ),
        Review(
